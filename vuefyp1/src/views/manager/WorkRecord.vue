...
<div>
    ...
    <div class="card" style="margin-bottom: 5px;">
      <el-table :data="data.tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column label="提交人" prop="ename"></el-table-column>
        <el-table-column label="提交数量" prop="number"></el-table-column>
        <el-table-column label="子任务id" prop="taskid"></el-table-column>
        <el-table-column label="子任务名" prop="name"></el-table-column>
...
// 导出
const exp = () => {
  location.href = 'http://localhost:8080/workrecord/export?token=' + data.user.token
}
