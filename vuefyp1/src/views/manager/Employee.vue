<template>
  <div>
		...
		<div class="card" style="margin-bottom: 5px">
			...
			<el-input v-model="data.search.sex" prefix-icon="Search" style="width: 240px; margin-right: 10px; margin-bottom: 3px" placeholder="请输入性别"></el-input>
			<el-input v-model="data.search.phone" prefix-icon="Search" style="width: 240px; margin-right: 10px; margin-bottom: 3px" placeholder="请输入手机"></el-input>
			<el-button type="info" plain @click="load">查询</el-button>
			<el-button type="warning" plain style="margin-right: 10px" @click="reset">重置</el-button>

			<el-upload v-if="data.user.role === 'admin'" :action="'http://localhost:8080/employee/upload?token=' + data.user.token" style="display: inline-block" :show-file-list="false" :on-success="impSuccessUpload">
    ...
    <el-dialog title="请填写信息" v-model="data.formVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="data.form" label-width="80px"  style="padding: 20px 30px">
				...
				<el-form-item label="职业技能" prop="skill">
					<el-checkbox-group v-model="data.form.skillList">
...
// 导出
const exp = () => {
	location.href = 'http://localhost:8080/employee/export?token=' + data.user.token
}
